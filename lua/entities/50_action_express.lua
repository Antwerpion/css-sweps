...
ENT.PrintName = ".50 Action Express"
ENT.Author = ""
ENT.Information = ""
ENT.Spawnable = true
ENT.AdminSpawnable = false
ENT.Category = "Counter-Strike: Source"
ENT.AmmoType = ".50 Action Express"
ENT.AmmoAmount = "7"
ENT.AmmoModel = "models/items/357ammobox.mdl"
...
if CLIENT then
         language.Add(".50 Action Express_ammo", ".50 Action Express")
end
