if CLIENT then
         ...
         killicon.AddFont( "p90", "CSKillIcons", "m", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.SpreadMax = 0.0732
SWEP.Primary.SpreadKick = 0.01951
SWEP.Primary.SpreadMove = 0.08382
SWEP.Primary.SpreadAir = 0.16494
SWEP.Primary.SpreadRecoveryTime = 0.32605
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "M", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
