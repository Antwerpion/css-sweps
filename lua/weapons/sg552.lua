if CLIENT then
         ...
         killicon.AddFont( "sg552", "CSKillIcons", "A", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.SpreadMax = 0.1227
SWEP.Primary.SpreadKick = 0.0054
SWEP.Primary.SpreadMove = 0.06132
SWEP.Primary.SpreadAir = 0.33464
SWEP.Primary.SpreadKickAlt = 0.00378
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "[", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
