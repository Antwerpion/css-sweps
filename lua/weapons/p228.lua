if CLIENT then
         ...
         killicon.AddFont( "p228", "CSKillIcons", "y", Color( 255, 80, 0, 255 ) )
end
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "Y", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
