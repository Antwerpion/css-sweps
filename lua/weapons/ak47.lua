if CLIENT then
         ...
         surface.CreateFont("CSSelectIcons", {font = "counter-strike", size = 144, weight = 0}) surface.CreateFont("CSKillIcons", {font = "csd", size = 48, weight = 0})
         killicon.AddFont("ak47", "CSKillIcons", "b", Color(255, 80, 0, 255))
end
...
SWEP.Primary.SpreadMax = 0.1158
SWEP.Primary.SpreadKick = 0.00916
SWEP.Primary.SpreadMove = 0.09222
SWEP.Primary.SpreadAir = 0.43044
SWEP.Primary.SpreadRecoveryTime = 0.48815
...
function SWEP:DrawWeaponSelection(x, y, wide, tall)
         draw.SimpleText("B", "CSSelectIcons", x + wide / 2, y + tall / 2, Color(255, 255, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
end
