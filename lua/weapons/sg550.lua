if CLIENT then
         ...
         killicon.AddFont( "sg550", "CSKillIcons", "o", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.Spread = 0.0257
SWEP.Primary.SpreadMin = 0.0257
SWEP.Primary.SpreadMax = 0.03829
SWEP.Primary.SpreadKick = 0.0257
SWEP.Primary.SpreadMove = 0.21864
SWEP.Primary.SpreadAir = 0.43727
SWEP.Primary.SpreadMinAlt = 0.0003
SWEP.Primary.SpreadKickAlt = 0.002
SWEP.Primary.SpreadRecoveryTime = 0.29358
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "O", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
