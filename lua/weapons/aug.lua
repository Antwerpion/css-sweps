if CLIENT then
         ...
         killicon.AddFont( "aug", "CSKillIcons", "e", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.SpreadMax = 0.109
SWEP.Primary.SpreadKick = 0.00549
SWEP.Primary.SpreadMove = 0.07268
SWEP.Primary.SpreadAir = 0.36936
SWEP.Primary.SpreadKickAlt = 0.00385
SWEP.Primary.SpreadRecoveryTime = 0.42368
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "E", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
...
function SWEP:SecondaryAttack()
         if self.Scope == 0 then
                  ...
                  self.Weapon:SetNWInt( "MouseSensitivity", 0.67 )
                  self.Owner:SetFOV( self.Owner:GetFOV() / 1.5, 0.2 )
