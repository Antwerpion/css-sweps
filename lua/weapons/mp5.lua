if CLIENT then
         ...
         killicon.AddFont( "mp5", "CSKillIcons", "x", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.SpreadMax = 0.0638
SWEP.Primary.SpreadKick = 0.01718
SWEP.Primary.SpreadMove = 0.08165
SWEP.Primary.SpreadAir = 0.23025
SWEP.Primary.SpreadRecoveryTime = 0.39144
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "X", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
