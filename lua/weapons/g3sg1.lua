if CLIENT then
         ...
         killicon.AddFont( "g3sg1", "CSKillIcons", "i", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.Spread = 0.0258
SWEP.Primary.SpreadMin = 0.0258
SWEP.Primary.SpreadMax = 0.04989
SWEP.Primary.SpreadKick = 0.0258
SWEP.Primary.SpreadMove = 0.23279
SWEP.Primary.SpreadAir = 0.46557
SWEP.Primary.SpreadMinAlt = 0.0003
SWEP.Primary.SpreadKickAlt = 0.002
SWEP.Primary.SpreadRecoveryTime = 0.31142
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "I", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
