if CLIENT then
         ...
         killicon.AddFont( "scout", "CSKillIcons", "n", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.Spread = 0.0317
SWEP.Primary.SpreadMin = 0.0317
SWEP.Primary.SpreadMax = 0.06667
SWEP.Primary.SpreadKick = 0.0257
SWEP.Primary.SpreadMove = 0.06667
SWEP.Primary.SpreadAir = 0.06667
SWEP.Primary.SpreadMinAlt = 0.0003
SWEP.Primary.SpreadKickAlt = 0.004
SWEP.Primary.SpreadRecoveryTime = 0.24753
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "N", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
...
function SWEP:SecondaryAttack()
         ...
         if self.Scope == 0 then
                  ...
                  self.Owner:SetWalkSpeed( 176 )
                  self.Owner:SetRunSpeed( 352 )
         else
