if CLIENT then
         ...
         killicon.AddFont( "fiveseven", "CSKillIcons", "u", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.SpreadMax = 0.05883
SWEP.Primary.SpreadKick = 0.01
SWEP.Primary.SpreadMove = 0.07421
SWEP.Primary.SpreadAir = 0.25635
SWEP.Primary.SpreadRecoveryTime = 0.22353
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "U", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
