if CLIENT then
         ...
         killicon.AddFont( "mac10", "CSKillIcons", "l", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.SpreadMax = 0.0845
SWEP.Primary.SpreadKick = 0.019
SWEP.Primary.SpreadMove = 0.0907
SWEP.Primary.SpreadAir = 0.13704
SWEP.Primary.SpreadRecoveryTime = 0.35368
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "L", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
