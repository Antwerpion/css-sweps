if CLIENT then
         ...
         killicon.AddFont( "m3", "CSKillIcons", "k", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.SpreadMax = 0.04164
SWEP.Primary.SpreadKick = 0.01
SWEP.Primary.SpreadMove = 0.0432
SWEP.Primary.SpreadAir = 0.42
SWEP.Primary.SpreadRecoveryTime = 0.41447
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "K", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
