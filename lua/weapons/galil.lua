if CLIENT then
         ...
         killicon.AddFont( "galil", "CSKillIcons", "v", Color( 255, 80, 0, 255 ) )
end
...
SWEP.Primary.SpreadMax = 0.0984
SWEP.Primary.SpreadKick = 0.01253
SWEP.Primary.SpreadMove = 0.10561
SWEP.Primary.SpreadAir = 0.45434
SWEP.Primary.SpreadRecoveryTime = 0.49275
...
function SWEP:DrawWeaponSelection( x, y, wide, tall )
         draw.SimpleText( "V", "CSSelectIcons", x + wide / 2, y + tall / 2, Color( 255, 255, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
end
